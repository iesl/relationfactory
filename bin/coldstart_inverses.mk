...
candidates_inv: candidates
	$(TAC_ROOT)/components/bin/invert_candidates.sh $+ $@
candidates_inv.pb: candidates_inv
	$(TAC_ROOT)/components/bin/cands_to_proto.sh $+ $@
sfeatures_inv: candidates_inv.pb
	$(TAC_ROOT)/components/bin/sfeatures.sh $+ $@
predictions_classifier_inv: sfeatures_inv
	$(TAC_ROOT)/components/bin/predictions_inverses.sh $+ $@
predictions_classifier: predictions_classifier_inv
...
response_shortened_patterns_plus: query_expanded.xml response_alternate_names response_classifier response_shortened_patterns response_induced_patterns response_patterns
	$(TAC_ROOT)/components/bin/merge_responses.sh $+ > $@
